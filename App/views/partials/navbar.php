        ...
        <nav class="space-x-4">
            <?php if (Session::has('user')) { ?>
                <div class="flex justify-between items-center gap-4">
                    ...
                    <form>
                        <button type="submit" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded hover:shadow-md transition duration-300"><i class="fa fa-sign-out"></i> Logout</button>
                    </form>
